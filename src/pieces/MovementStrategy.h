...
public:
    ...
    virtual bool ValidateMove(Board& board, COLOUR playerColor,Vector2 from, Vector2 to) const = 0;
};

class RookMovement : public MovementStrategy {
    public:
        bool ValidateMove(Board& board, COLOUR playerColor,Vector2 from, Vector2 to) const override;
};
